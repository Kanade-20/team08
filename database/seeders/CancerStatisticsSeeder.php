...
class CancerStatisticsSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $faker = Faker::create();
        $genders = ['全', '男', '女'];
        $cities = ['全省', '台北市', '高雄市', '台中市', '台南市', '新北市', '桃園市', '基隆市', '新竹市', '嘉義市', '台北縣', '桃園縣', '新竹縣', '苗栗縣', '台中縣', '彰化縣', '南投縣', '雲林縣', '嘉義縣', '台南縣', '高雄縣', '屏東縣', '花蓮縣', '台東縣', '澎湖縣', '金門縣', '連江縣'];
