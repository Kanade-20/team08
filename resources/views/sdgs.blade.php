...
@section('content')
    <div class="sdgs_container">
        ...
        <p class="lead text-center">探索17項全球可持續發展目標，讓我們一起為地球的未來努力！</p>
        <hr>
        <main>
            <section class="goals">
                <div class='main_content'>
                <div class="goal">
                    <img src="{{ asset('images/goals/1.jpg') }}" alt="目標1">
                ...
                <div class="goal">
                    <img src="{{ asset('images/goals/2.jpg') }}" alt="目標2">
                ...
                <div class="goal">
                    <img src="{{ asset('images/goals/3.jpg') }}" alt="目標3">
                ...
                <div class="goal">
                    <img src="{{ asset('images/goals/4.jpg') }}" alt="目標4">
                ...
                <div class="goal">
                    <img src="{{ asset('images/goals/5.jpg') }}" alt="目標5">
                ...
                <div class="goal">
                    <img src="{{ asset('images/goals/6.jpg') }}" alt="目標6">
                ...
                <div class="goal">
                    <img src="{{ asset('images/goals/7.jpg') }}" alt="目標7">
                ...
                <div class="goal">
                    <img src="{{ asset('images/goals/8.jpg') }}" alt="目標8">
                ...
                <div class="goal">
                    <img src="{{ asset('images/goals/9.jpg') }}" alt="目標9">
                ...
                <div class="goal">
                    <img src="{{ asset('images/goals/10.jpg') }}" alt="目標10">
                ...
                <div class="goal">
                    <img src="{{ asset('images/goals/11.jpg') }}" alt="目標11">
                ...
                <div class="goal">
                    <img src="{{ asset('images/goals/12.jpg') }}" alt="目標12">
                ...
                <div class="goal">
                    <img src="{{ asset('images/goals/13.jpg') }}" alt="目標13">
                ...
                <div class="goal">
                    <img src="{{ asset('images/goals/14.jpg') }}" alt="目標14">
                ...
                <div class="goal">
                    <img src="{{ asset('images/goals/15.jpg') }}" alt="目標15">
                ...
                <div class="goal">
                    <img src="{{ asset('images/goals/16.jpg') }}" alt="目標16">
                ...
                <div class="goal">
                    <img src="{{ asset('images/goals/17.jpg') }}" alt="目標17">
