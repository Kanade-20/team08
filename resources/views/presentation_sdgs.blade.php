    ...
    <main>
        ...
        <section>
            ...
            <ul class="my_sdg3">
                ...
                <h1>癌症介紹</h1>
                <p >癌症又稱惡性瘤、惡性腫瘤是各種惡性腫瘤的統稱，相對於良性腫瘤，分為上皮癌和肉瘤兩大類。
                    癌症與良性腫瘤不同處在於：其細胞處於失控狀態，生長和分裂速率快，
                    具有浸潤、侵蝕和轉移的性質，並且分化不成熟、高度退行發育，自然過程呈致死性。
                    癌症的症狀多樣，除可引起局部壓迫和阻塞等症狀外，還可因浸潤和轉移而導致相應的臨床表現，
                    有時會出現貧血、發熱、體重下降、夜汗、感染、惡病質等全身表現。
                    生物體控制細胞分裂的機制失常後，細胞異常增生並侵犯身體的其他部分就會引發症狀。
                    除了分裂失控外，還會局部侵入週遭正常組織甚至經由體內循環系統或淋巴系統轉移到身體其他部分，
                    不是所有的腫瘤都會癌化，有些細胞異常增生但不會侵犯身體其他部分則稱為良性腫瘤，在人類身上，目前已知的癌症超過一百種。                
                </p>    
                <h1>癌症預防</h1>
                <p>依據世界衛生組織報告，菸、酒、不健康飲食、缺乏身體活動及肥胖等都是誘發癌症的主要危險因子，且至少有1/3的癌症是可以預防的。以下是幾個預防癌症的辦法。</p>
                ...
                <p class="text_comtent">使用菸草不僅會對人體造成危害也會致癌，與酒精類飲品併用時，更是加劇對人體的危害程度。
                   研究顯示，肺癌患者中高達90%的比例有吸菸的習慣，是導致肺癌的最主要原因。
                   而檳榔子（菁仔）亦屬於第一類致癌物，嚼不含任何添加物的檳榔子也會致癌。
                   所有癌症的死亡人口中亦有3.6%的比例與飲酒有關。
                </p>
                ...
                <p class="text_comtent">世界衛生組織指出，每年約有超過50萬人死於原發性肝癌，而B、C型肝炎病毒為肝癌的首要危險因子。
                   據調查，8成以上的肝癌是由B型肝炎病毒所引起，施打B型肝炎疫苗則可有效避免感染B型肝炎而降低罹患肝癌風險。
                   感染人類乳突病毒（human papillomavirus, HPV）會誘發子宮頸、生殖器等部位的癌症外，也會導致頭部、頸部等部位發生鱗狀細胞癌。
                   施打HPV疫苗，可預防約6至7成的子宮頸癌症發生。因此國民健康署現有提供中低收入戶、低收入戶和山地原住民族地區及離島地區國中少女施打HPV疫苗。
                </p>
                ...
                <p class="text_comtent">國民健康署補助之乳癌、大腸癌、子宮頸癌和口腔癌篩檢，都是WHO建議可以經由篩檢，早期發現早期治療之癌症。
                   除了關心飲食和生活作息，也要記得定期接受癌症篩檢，千萬不要因為自覺身體健康就輕忽定期篩檢的重要性，
