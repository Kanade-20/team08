...
class CreateCancerStatisticRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'city_county' => 'required|string|min:2|max:191',
            'cancer_type' => 'required|string|min:2|max:191',
